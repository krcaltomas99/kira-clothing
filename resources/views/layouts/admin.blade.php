...
<head>
	...
	<link rel="stylesheet" href="{{ secure_asset("dropzone/dist/min/dropzone.min.css") }}">
...
<script src="{{ secure_asset("googleclick/js/googleclick.js") }}"></script>
