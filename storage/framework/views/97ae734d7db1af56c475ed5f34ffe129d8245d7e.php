					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-7">
								...
								<div class="form-group row">
									<div class="col-md-7 offset-md-4">
										<div class="form-check">
											<?php echo e(Form::checkbox("remember", "remember",false, ["class"=>"form-check-input", "arial-label"=>"Login", "id"=>"remember"])); ?>

											<?php echo e(Form::label("remember", "Remember me", ["class"=>"form-check-label"])); ?>
								...
								<div class="form-group row">
									<div class="col-md-8 offset-md-4">
										<a href="<?php echo e(route("register")); ?>"><?php echo e(__("Don't have an account? Register now.")); ?></a>
									</div>
								</div>
							</div>
							<div class="col-md-5">
									...
									<div class="col-11 col-md-12 col-lg-9 mx-auto">
										<a href="<?php echo e(url('/auth/facebook')); ?>"
										   class="btn btn-facebook d-flex btn-wave align-items-center justify-content-start">
											<img class="mr-2" height="30"
											     src="<?php echo e(secure_asset("storage/images/facebooklogo.png")); ?>" alt="">
