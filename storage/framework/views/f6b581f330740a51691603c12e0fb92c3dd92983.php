							...
							<div class="row">
											...
											<div class="row">
												<div class="col-12">
													<div class="avatar medium float-left">
														<img id="img_prev"
														     src="<?php echo e(asset("storage/userAvatars/user.png")); ?>"
														     alt="avatar" width="32">
													</div>
													<label class="m-0 ml-2 clickable btn btn-blank text-primary" for="cover_image">Upload</label>
									...
									<div class="form-group row mb-0">
										<div class="col-12 col-md-11">
											<button style="display: block;" type="submit"
											        class="btn btn-wave btn-primary ml-auto">
								...
								<div class="col-md-5 col-12 register-left ">
									<div class="form-group">
										<h5 class="text-center my-4 mt-lg-0">Sign up with Google or Facebook and we'll
											do the rest</h5>
