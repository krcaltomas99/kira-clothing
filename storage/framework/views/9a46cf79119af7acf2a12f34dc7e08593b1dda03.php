<nav class="navbar navbar-expand-md navbar-light navbar-kira">
	<a class="navbar-brand admin pr-3" href="<?php echo e(route("admin.index")); ?>">
		Kira Admin
	</a>
	<p class="mb-0"><a target="_blank" href="<?php echo e(route("home")); ?>">Home</a></p>
		...
		<ul class="navbar-nav mr-auto d-block d-md-none">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					...
					<a class="dropdown-item" href="<?php echo e(route("products.create")); ?>">Add a product</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo e(route("sections.index")); ?>">Categories</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo e(route("tags.index")); ?>">Tags</a>
				</div>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo e(route("sliders.index")); ?>">Slider</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo e(route("collections.index")); ?>">Collections</a>
			</li>
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown1">
					<a class="dropdown-item" href="<?php echo e(route("admin.users.clients")); ?>">Customers</a>
					<a class="dropdown-item" href="<?php echo e(route("admin.users.employees")); ?>">Employees</a>
					<a class="dropdown-item" href="<?php echo e(route("admin.users.user")); ?>">Users</a>
				</div>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo e(route("collections.index")); ?>">Orders</a>
			</li>
		</ul>
	</div>
</nav>
				...
				<div class="col-10">
					...
					<?php if(Auth::user()->isSuperAdmin()): ?>
						<small><a onclick="return confirm('You are about to migrate the database. Are you sure?')"
						          href="<?php echo e(route("migrate")); ?>">migrate</a></small>
						<small class="d-inline-block px-1"> |</small>
						<small><a onclick="return confirm('You are about to rollback the database. Are you sure?')"
						          class="text-danger" href=<?php echo e(route("rollback")); ?>>rollback</a></small>
					<?php endif; ?>
				</div>
			</div>
		</div>
...
<?php if(Request::is('KC-admin/products*') || Request::is('KC-admin/sections*') || Request::is('KC-admin/tags*')): ?> active <?php endif; ?>"
				        <?php if(!Request::is('KC-admin/products*') && !Request::is('KC-admin/sections*') && !Request::is('KC-admin/tags*')): ?> data-additional-styles="dark" <?php endif; ?>>
					<a href="<?php echo e(route("products.index")); ?>">
						<i class="fas fa-box-open"></i> Products
					</a>
				</button>
				<button type="button"
				        class="btn btn-light dropdown-toggle dropdown-toggle-split <?php if(Request::is('KC-admin/products*')
				         || Request::is('KC-admin/sections*')
				         || Request::is("KC-admin/tags*")): ?> active <?php endif; ?>"
			...
			<?php if(Request::is('KC-admin/products*') || Request::is('KC-admin/sections*') || Request::is("KC-admin/tags*")): ?>
			...
			<li class="dropright">
				<button type="button"
				        class="btn btn-light btn-block btn-wave <?php if(Request::is('KC-admin/orders*')): ?> active <?php endif; ?>"
				        <?php if(!Request::is('KC-admin/orders*')): ?> data-additional-styles="dark" <?php endif; ?>>
