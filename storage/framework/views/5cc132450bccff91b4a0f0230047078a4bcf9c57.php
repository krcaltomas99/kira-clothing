<?php $__env->startSection("title", "Edit $topic->name"); ?>

<?php $__env->startSection("content"); ?>
	<div class="col-8">
		<div class="admin-block">
			<div class="admin-header">
				<h3>Edit topic: <?php echo e($topic->name); ?></h3>
			</div>
			<div class="admin-body">
				<?php echo e(Form::open(["url"=>route("topics.update", $topic->id),"class"=>"" ,"method"=>"PUT","enctype"=>"multipart/form-data"])); ?>

				<div class="form-group row">
					<?php echo e(Form::label("name", "Name", ["class"=>"col-sm-3 col-form-label text-md-left"])); ?>

					<div class="col-sm-8">
						<?php echo e(Form::text("name", $topic->name, ["class"=>"form-control"])); ?>
